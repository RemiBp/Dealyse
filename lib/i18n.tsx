...
const translations = {
  fr: {
    ...
    hero: {
      ...
      sub: "Due diligence financière, juridique et opérationnelle accélérée sur Palantir Foundry. Moins d'Excel, moins de friction.",
    ...
    footer: {
      tagline: "Le Deal OS M&A — sur Palantir Foundry.",
      solutions: "Solutions",
      product: "Produit",
  ...
  en: {
    ...
    hero: {
      ...
      h1b: "in 4 hours.",
      sub: "Financial, legal, and operational due diligence accelerated on Palantir Foundry. Less Excel, less friction.",
    ...
    footer: {
      tagline: "The M&A Deal OS — on Palantir Foundry.",
      solutions: "Solutions",
      product: "Product",
      resources: "Resources",
      legal: "Legal",
